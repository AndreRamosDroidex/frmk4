...
class ConfigManager:
    ...
    def __init__(self, id_tracking: str, id_process: str, fecinformacion: str, datacenter: str, log = None):
        ...
        if self.origen.get("local-new-egde", False):
            # New Egde
            file_global_json = f"/data/desa/IBKProjects/DataHub/frmk4/on_premise/config/global/config-global.json"
            file_process_json = f"/data/desa/IBKProjects/DataHub/frmk4/on_premise/config/process/config-process-4001.json"
        elif self.origen.get("local-ec2", False):
            # AWS - EC2
            file_global_json = f"/home/ubuntu/frmk4/on_premise/config/global/config-global.json"
            file_process_json = f"/home/ubuntu/frmk4/on_premise/config/process/config-process-4001.json"
